		...
		<div class="container">
			<ol class="breadcrumb breadcrumb1">
				...
				<li class="active">Success Page</li>
						...
						echo'<div><p align="middle" style="font-size:20px"><b>Product '.$_SESSION['ro'].' t '.$_SESSION['q1'].' t '.$_SESSION['q2'].'" is not available</b></p></div>';
							}
					else{
						echo'<div><p align="middle" style="font-size:20px "><b>ERROR</b></p></div> ';
					}
							?>		
